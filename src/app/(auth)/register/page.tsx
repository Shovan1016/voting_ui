...
export default function RegisterPage() {
  ...
  const inputClass = (id: keyof typeof formik.values) =>
    `w-full rounded-xl bg-white/[0.04] border pl-10 pr-4 py-3 text-sm text-white placeholder-zinc-500 outline-none transition-all duration-200 focus:ring-2 focus:ring-violet-500/40 focus:border-violet-500/40 focus:bg-white/[0.06] hover:bg-white/[0.06] ${
      ...
      >
        ...
        {isSuccess && (
          <motion.div
            initial={{ opacity: 0, y: -8, scale: 0.95 }}
            animate={{ opacity: 1, y: 0, scale: 1 }}
            className="mb-5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 px-4 py-3 text-sm text-emerald-400 flex items-center gap-2"
          >
